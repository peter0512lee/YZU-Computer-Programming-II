#include<iostream>
#include<iomanip>
#include"s1061443_NComplex.h" //Before your test this driver program, please replace it by your own file name.
...
int main(int argc, char *argv[]) {
	NComplex n1(-5, 2), n2(-3, 6), n3(3, -2), n4; //Note, the default complex number is 0+0i
